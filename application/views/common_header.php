...
#main-wrapper{width:1000px;float:left;margin:0px;padding:10px 10px 10px 10px;word-wrap:break-word;overflow:hidden;background:url(/assets/images/paperwork.png);background-repeat:no-repeat;}
