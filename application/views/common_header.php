...
#main-wrapper{border:solid 1px #000000;width:900px;float:left;margin:0px;padding:10px 5px 10px 10px;word-wrap:break-word;overflow:hidden;background:url(/assets/images/paperwork.png);background-repeat:no-repeat;}
