...
/* Outer-Wrapper----------------------------------------------- */
#outer-wrapper{border:solid 1px #ff0000;width:960px;margin:15px auto 0px;padding:0px;text-align:left;background:url(http://2.bp.blogspot.com/-OfL7G6BSZ4A/URQb0FIwdbI/AAAAAAAACIw/bRKeGl7DpE8/s000/container-bg.png) left top repeat-x;}
#content-wrapper{background:#fff;padding:15px;}
#main-wrapper{border:solid 1px #000000;width:900px;float:left;margin:0px;padding:10px 10px 10px 10px;word-wrap:break-word;overflow:hidden;background:url(/assets/images/paperwork.png);background-repeat:no-repeat;}
