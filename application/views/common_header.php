...
/* Outer-Wrapper----------------------------------------------- */
#outer-wrapper{height:95%;border:solid 1px #7ACE10;width:960px;margin:15px auto 0px;padding:0px;text-align:left;background:url(http://2.bp.blogspot.com/-OfL7G6BSZ4A/URQb0FIwdbI/AAAAAAAACIw/bRKeGl7DpE8/s000/container-bg.png) left top repeat-x;}
#content-wrapper{border:solid 0px #FF0000;background:#fff;padding:15px;height:65%;}
