...
/* Outer-Wrapper----------------------------------------------- */
#outer-wrapper{border:solid 1px #7ACE10;width:960px;margin:0px auto 0px;padding:0px;text-align:left;background:url(http://2.bp.blogspot.com/-OfL7G6BSZ4A/URQb0FIwdbI/AAAAAAAACIw/bRKeGl7DpE8/s000/container-bg.png) left top repeat-x;}
...
<?PHP if (isset($_COOKIE['level'])){ if ($_COOKIE['level'] != 'Operations'){ ?><li><a href='http://syndicatestream.com/admin'>Administration</a></li><?PHP }} ?>
