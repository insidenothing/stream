...
<div id='header-inner'>
<input name="email" value="E-Mail Address" onclick="this.value='';" style="z-index:10;"> <input value="Password" name="password" onclick="this.value='';" style="z-index:10;"> <input type="submit" value="Log In" style="z-index:10;"> 
</div>
</div></div>
