 ...
 We give you the tools to manage your risk the most efficiently. You know it as it happens. The streaming edge.<br /><br /><br /><?PHP if (empty($_COOKIE['name'])){ ?><a href="/pricing"><img src="/assets/images/begin.png"></a><?PHP } ?>
